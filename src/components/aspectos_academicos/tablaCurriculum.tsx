...
<div className="flex justify-center my-10">
        ...
        <table className="table-auto border-collapse border my-5 w-full mpx-10">
                <thead className="text-black">
                  <tr>
                    ...
                    <th className="text-center">
                      {" "}
                      <tr>TIPO CREDITO</tr>
                      <tr>OBLIGATORIOS </tr> <tr>ELECTIVOS</tr>{" "}
                      <tr>OPTATIVOS </tr>{" "}
                    </th>
                    <th className="text-center">
                      <tr># HORAS </tr>
                ...
                <tbody>
                  ...
                  <tr>
                    <td className=""><tr>INTRODUCCIÓN A LA</tr><tr> VIDA UNIVERSITARIA</tr></td>
                    <td className="">1</td>
                    <td className="">OBLIGATORIO</td>
                    <td className="">1</td>
                    <td className="">0</td>
                  ...
                  <tr>
                    <td className=""><tr>INTRODUCCIÓN A LA</tr> <tr> INGENIERIA ELECTROMECÁNICA</tr></td>
                    <td className="">2</td>
                    <td className="">OBLIGATORIO</td>
                    <td className="">2</td>
                    <td className="">0</td>
                  ...
                  <tr>
                    ...
                    <td className="border-t border-black">MATERIALES ELECTRÓNICOS Y MAGNETICOS</td>
                    <td className="border-t border-black">3</td>
                    <td className="border-t border-black">OBLIGATORIO</td>
                    <td className="border-t border-black">4</td>
                    <td className="border-t border-black">0</td>
                  ...
                  <tr>
                    ...
                    <td className="border-t border-black">SISTEMAS ELÉCTRICOS DE POTENCIA</td>
                    <td className="border-t border-black">3</td>
                    <td className="border-t border-black">OBLIGATORIO</td>
                  ...
                  <tr>
                    ...
                    <td className="border-t border-black">LABORATORIO DE MÁQUINAS ELÉCTRICAS II</td>
                    <td className="border-t border-black">1</td>
                    <td className="border-t border-black">OBLIGATORIO</td>
                    <td className="border-t border-black">0</td>
                    <td className="border-t border-black">0</td>
                  ...
                  <tr>
                    ...
                    <td className="border-t border-black">LABORATORIO DE ELECTRONICA DE POTENCIA II</td>
                    <td className="border-t border-black">2</td>
                    <td className="border-t border-black">OBLIGATORIO</td>
                    <td className="border-t border-black">0</td>
                    <td className="border-t border-black">0</td>
